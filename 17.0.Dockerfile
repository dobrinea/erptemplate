...
COPY lib/oneerplib /usr/local/lib/python3.10/site-packages/oneerplib
...
RUN mkdir -p auto/addons auto/geoip custom/src/private \
    ...
    && chmod -R a+rX /usr/local/lib/python3.10/site-packages/oneerplib \
...
LABEL org.label-schema.schema-version="$VERSION" \
      org.label-schema.vendor=Dobrinea \
      org.label-schema.license=Apache-2.0 \
      org.label-schema.build-date="$BUILD_DATE" \
      org.label-schema.vcs-ref="$VCS_REF" \
      org.label-schema.vcs-url="https://github.com/dobrinea/erptemplate"
